...
[   [   [33],
    ...
    [   [60],
        'System',
        'a6b1b7bf0059412dba334c711ea86f6b1eef9a7c',
        [   (0, 'd7bd7acd6662c2981bed17bb43f739776c82c437', None, 'ButtonUnchecked', 'P reset'),
            (1, '426f618b80b197435057bb39e86a3429d545be19', None, 'SubMenu', 'Remote'),
            (2, 'e7c6e10c58460dc2190cc981f9d2744c2277d3ab', None, 'SubMenu', 'P references'),
            (3, 'bb50a37eb62aa49158d90c0a78cfc4606b65048c', None, 'SubMenu', 'DatefTime'),
            (4, '81a1cd646e10c77a4e9ef8cf7ce62b5e31d43179', None, 'SubMenu', 'Diagnostics'),
            (5, '9af80938d33834a1df1263a8b04f9ae4b4f5671a', None, None, 'Macro'),
            (6, '6cdf1fe9748c66d7f5c76fd8db3959d690445162', None, 'SubMenu', 'Edit Macro'),
            (7, '71d8e71eee0e7a96c38910541555286c4a607dfe', None, 'ButtonUnchecked', 'Show Settings'),
            (8, 'f05d903cb61b25ef8c9976d9ba77b6889305473a', None, 'ButtonUnchecked', 'Show Version'),
            (9, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, '')],
        [   [   [60, 12],
                'Remote',
                'b623105103231509183bc7f40328d24abfe03b37',
                [   (0, '2db98b0c44e59801c4dd04a32826d2a471371787', None, None, 'Output To'),
                    (1, 'c475244835dd3b0809fa077cc1e22f585acb3827', None, None, 'GPIB Address'),
                    (2, '6ea1b50f687ead6f3aa9d88b3b80092a389706dd', None, None, 'Dveride REM?'),
                    (3, '2519fb4a250130370df36b4a2111f59e7ec02d29', None, None, 'Baud Rate'),
                    (4, '0b92a2424071c078c29882e526224ae5dbd74db7', None, None, 'Word Length'),
                    (5, '04d2e8ade847b5bd48a9bc42fdeafd5cce290a0b', None, None, 'P ari(Y'),
                    (6, 'c3f6528f0ee8d67cf4fe3a8edf0b32d56ea374f0', None, 'ButtonUnchecked', '\\\xef\xac\x81ew Q5'),
                    (7, '803eb2d5a78a1b4e8f07cb6f4cbc7600bbb0bcc1', 'Return', 'ButtonUnchecked', 'Return'),
                    (8, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                    (9, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, '')],
                []],
            [   [60, 11],
                'P references',
                '90db1a7766cb2521938408b93ea2eae6b9a6a452',
                [   (0, 'f946029359a89253977bd9741ada859ac5b9e896', None, None, 'Key Click'),
                    (1, 'bf0c42292316c77be5ebdd3487952a0d152faa8f', None, None, 'Alarms'),
                    (2, 'a72383528eeab0df3dffaa73bfa76db6a3774a8c', None, None, 'Alarms Volume'),
                    (3, '9256df0623fb67fbab37bfe163ab83351ac79067', None, None, '"Done" Volume'),
                    (4, '7542afe4d0a0081cb388cabb5cbc7ec0a86ebf59', None, None, 'Audible Overload'),
                    (5, '0b95164a11c78f0f43628d943e465c5104508421', None, None, 'Screen Saver'),
                    (6, 'afc1c16b4bbeabbbc8315dd9b0bccfb1cb79ed97', None, None, 'Screen Saver Delay'),
                    (7, 'e853d6d3f9fe5b6faec66c0d54b50203d8fcc18c', None, None, 'Frequency Format'),
                    (8, '469eacf9b46f23ef54b5ab0f0240592092f40afe', None, None, 'Node Info prompt?'),
                    (9, '31a9208809be93de5ad9d774e3e7ee88a4ae8246', None, None, ':\xe2\x80\x94.')],
                []],
            [   [60, 10],
                'Time',
                'c5a83efa0a1a70a067fe9801fe73795aad1720fa',
                [   (0, '966cca2d43a5af78fb54b24e6d520da02256673c', None, None, 'Time'),
                    (1, 'e18728cb207d3f4aebc8b58bfb503665346d9a9b', None, None, 'Date'),
                    (2, '803eb2d5a78a1b4e8f07cb6f4cbc7600bbb0bcc1', 'Return', 'ButtonUnchecked', 'Return'),
                    (3, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                    (4, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                    (5, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
            ...
            [   [60, 9],
                'Test',
                '590d8f294cb00f4da5b461b225e40fa36b6e8769',
                [   (0, '63ea621e5e3a3dc4c48efdc9cbccec925212c1f7', None, 'ButtonUnchecked', 'Keypad'),
                    (1, 'd1f5cd35e282774dad578370be4cad5e466c6b9c', None, 'ButtonUnchecked', 'Keyboard'),
                    (2, '6267778df5ac1c0fb8331c158064042b6480adc3', None, 'SubMenu', 'Knob'),
                    (3, 'a621b03ca6f568fb454c470f21483665399909bc', None, 'SubMenu', 'RS232 I P rinter'),
                    (4, '3df4282c08641bb8662ffb97148dd3bc27434771', None, 'SubMenu', 'Memory'),
                    (5, '0570d01c3b1d9d8e2a079db3b4f0b9aa6d608484', None, 'SubMenu', 'Disk'),
                    (6, '17e70a8fea56e5abd2e7d03637ac7221e6ac0fa9', None, None, 'Serial Number'),
                    (7, 'dbb526c39904b8ff67c4c393215964ff9a360401', None, 'ButtonUnchecked', 'Program SIN'),
                    (8, '54b3b69e491d1253474f43c1529811ec39c91460', None, 'ButtonUnchecked', 'Kill Auto\xef\xac\x82ff'),
                    (9, 'ba02911f66e5de00c895ce8bdbd8d596fc8e2edf', None, None, 'Return')],
                [   [   [60, 9, 11],
                        'Knob Tests',
                        '73d41e99f730b4b10b26b8d65ab630c6e0e577dd',
                        [   (0, 'da4e5888b202d382fe258c27008e9d80f7930285', None, None, 'Snail'),
                            (1, '7a1ef358555ae9d2256b924f1857c9619e6b0199', None, None, 'Human Baby'),
                            (2, 'a4022652a3d3c131806e5e91f86fb48042992744', None, None, 'Adult'),
                            (3, '20229e2bcb038822e9a8f6cf21781f9ecc2e2464', None, None, 'Lunatic'),
                            (4, '803eb2d5a78a1b4e8f07cb6f4cbc7600bbb0bcc1', 'Return', 'ButtonUnchecked', 'Return'),
                            (5, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                            (6, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                            (7, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                    ...
                    [   [60, 9, 10],
                        'RS232 I P rinter',
                        'c6349299e5fcd0ac60198a98be91be2175451b49',
                        [   (0, '9f0e24462170a5b1e1ee045841d35a4a85895bb6', None, 'ButtonUnchecked', 'Begin'),
                            (1, '7f60dd5686c8c76c7113025c494d7bfa8bdf496b', None, 'ButtonUnchecked', 'String to RS232'),
                            (2, '7066a51b681628c7e5591814c2ebb8cb34a1c4a1', None, 'ButtonUnchecked', 'String to Printer'),
                            (3, '803eb2d5a78a1b4e8f07cb6f4cbc7600bbb0bcc1', 'Return', 'ButtonUnchecked', 'Return'),
                            (4, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                            (5, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                            (6, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                            (7, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                    ...
                    [   [60, 9, 9],
                        'Memory Tests',
                        '3600290010aef50c267717a32b7ad2f8d35f574b',
                        [   (0, '9df39db80d4adcd0ed68313748a58352d6f2b216', None, 'SubMenu', 'System RAM'),
                            (1, 'f8b80c4fd09342a879cd6ad5f0229dfde551a4e2', None, 'SubMenu', 'System ROM'),
                            (2, 'f6044ef1442636b20bfbc664662f0edee82fd3b8', None, 'SubMenu', '\\\xef\xac\x81deo RAM'),
                            (3, '9127c745e6061f90b928bbe57be4dc0434acdcf5', None, 'SubMenu', 'Help ROM'),
                            (4, '803eb2d5a78a1b4e8f07cb6f4cbc7600bbb0bcc1', 'Return', 'ButtonUnchecked', 'Return'),
                            (5, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                            (6, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                            (7, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                        ...
                        [   [   [60, 9, 9, 0],
                                'System RAM',
                                '1c4ca7c5897bf8ff5c06730a3ba4f9fe5a367230',
                                [   (0, '9f0e24462170a5b1e1ee045841d35a4a85895bb6', None, 'ButtonUnchecked', 'Begin'),
                                    (1, '803eb2d5a78a1b4e8f07cb6f4cbc7600bbb0bcc1', 'Return', 'ButtonUnchecked', 'Return'),
                                    (2, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                                    (3, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                                    (4, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                                    (5, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                                    (6, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                            ...
                            [   [60, 9, 9, 12],
                                'System ROM',
                                '951e48160c336b196a0d3795d738c901c0cb8c51',
                                [   (0, '9f0e24462170a5b1e1ee045841d35a4a85895bb6', None, 'ButtonUnchecked', 'Begin'),
                                    (1, '803eb2d5a78a1b4e8f07cb6f4cbc7600bbb0bcc1', 'Return', 'ButtonUnchecked', 'Return'),
                                    (2, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                                    (3, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                            ...
                            [   [60, 9, 9, 10],
                                'Help ROM',
                                '8f688d155aabd132840ae6430783f0a4e3eedc3c',
                                [   (0, '9f0e24462170a5b1e1ee045841d35a4a85895bb6', None, 'ButtonUnchecked', 'Begin'),
                                    (1, '803eb2d5a78a1b4e8f07cb6f4cbc7600bbb0bcc1', 'Return', 'ButtonUnchecked', 'Return'),
                                    (2, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                                    (3, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                    ...
                    [   [60, 9, 8],
                        'Disk Tests',
                        '98fb18487561fb40be98e4a3b1ea1800818ba1eb',
                        [   (0, '9f0e24462170a5b1e1ee045841d35a4a85895bb6', None, 'ButtonUnchecked', 'Begin'),
                            (1, '803eb2d5a78a1b4e8f07cb6f4cbc7600bbb0bcc1', 'Return', 'ButtonUnchecked', 'Return'),
                            (2, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                            (3, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
            ...
            [   [60, 16],
                'Edit Macro',
                'd3f72878e5f28db2546087251f0612b5aef92c80',
                [   (0, '527f04e02cdb87d6406a8788aeb9146012245d41', None, 'ButtonUnchecked', 'Special Keys'),
                    (1, '7c1aede00028039f87fcf0183b02e46bc13ae069', None, 'ButtonUnchecked', 'Macro String'),
                    (2, 'b0ea50dad5d2079d9bb440d5aa52cbb0ddac1d2e', None, 'ButtonUnchecked', '<|nsert IRep|ace>'),
                    (3, '78baf0f7efee8439fbec28e8a093b6cd931d6009', None, 'ButtonUnchecked', 'Inc. Knob Count'),
                    (4, '8be4b4404515d3239a0df6291adf3826779889d2', None, 'ButtonUnchecked', 'Dec. Knob Count'),
                    (5, 'a95d33192d1622331c5573399dac474664ed339f', None, 'ButtonUnchecked', 'Delete'),
                    (6, 'a885a79d14396ef1849d258d4bad1102f11ee40f', None, 'ButtonUnchecked', 'Clear Macro'),
                    (7, '5966ee15eaa505a47ed4c14544cda4132cf72afa', None, 'ButtonUnchecked', 'Cancel'),
                    (8, '4d8c0270cad6cd45dbe3afacaabb0ba830015f88', 'Black', None, ''),
                    (9, 'c3be1f9b394faaeb54831637297462dfe06bd4c9', None, None, 'Enter Macro')],
                []]]]]