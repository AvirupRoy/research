...
class LockinThermometerWithExpandWidget(Ui.Ui_Form, QWidget):
    def __init__(self,parent=None):
        ...
        self.lia=SR830(None)
        self.lia.sensitivity.populateEnumComboBox(self.minSensitivityCombo)
    ...
    def updateValues(self,f,X,Y):
        ...
        sensitivity = self.lia.sensitivity.value
    ...
    def setupAutomaton(self):
        self.PDA=LockinThermometerAutomaton(self.lia,self.updateValues)
